...
class Bank():
    def __init__(self) -> None:
        ...
        self.__last_account_id = int(
            select_last_id(self.conn, "accounts", "acc_id"))
    ...
    def register_user(self, user: "User"):
        ...
        add_user(self.conn, user.id, user.fname,
    ...
    def create_account(self, user: "User"):
        ...
        add_account(self.conn, new_account.id,
                    user.id, new_account.get_balance())
        print("Account with id {} created for user {} {} ".format(
            new_account.id, user.fname, user.lname))
